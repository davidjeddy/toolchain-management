...
yes | sudo rm -rf "$HOME/.jenkins" || true
yes | sudo rm -rf "$HOME/.kics" || true
yes | sudo rm -rf "$HOME/.oiq" || true
yes | sudo rm -rf "$HOME/.tenv" || true

# 0.67.x

yes | sudo rm -rf "/usr/bin/asdf" || true
yes | sudo rm -rf "$HOME/.asdf" || true
yes | sudo rm -rf "$HOME/.kics/bin/kics" || true
