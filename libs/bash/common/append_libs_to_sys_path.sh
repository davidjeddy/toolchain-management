...
append_add_path "$PWD/../aws" "$SESSION_SHELL"
append_add_path "$PWD/../common" "$SESSION_SHELL"
append_add_path "$PWD/../container" "$SESSION_SHELL"
append_add_path "$PWD/../git" "$SESSION_SHELL"
append_add_path "$PWD/../iac" "$SESSION_SHELL"
